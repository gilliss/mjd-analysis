...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(enrType==2)mg->GetYaxis()->SetRangeUser(0.0,2.7);
    TAxis* a = mg->GetXaxis();
    int j = 1;
    int bin_j;
...
//    legend->Draw();
    ...
    TLatex tlatex;
    tlatex.SetTextSize(12);
    tlatex.DrawLatex(0.85*groupingFill.size(), 2.5, Form("Avg Counts: %.2f", avgCnts));
    tlatex.DrawLatex(0.85*groupingFill.size(), 2.35, Form("Fit: %.2f +/- %.2f", p0, p0Err));
    canv->Update();
