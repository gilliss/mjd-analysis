...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //TCanvas* cLowE_Prompt_Cleaned = new TCanvas();
    
    TCanvas* cDelayed = new TCanvas();
    ...
    TH1D *hDelayed = new TH1D("hDelayed", "hDelayed", 300, 0, max_E);
    ...
    TH1D *hFullE = new TH1D("hFullE", "hFullE", nbins_E, 0, max_E);
    TH1D *hFullE_SansDelayed = new TH1D("hFullE_SansDelayed", "hFullE_SansDelayed", nbins_E, 0, max_E);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(int k=0;k<nentriesOriginal;k++)
    {
        ...
        for(int j=0; j<chanSize; j++) // loop through channels in the entry
        {
            ...
            if(chIndex!=1000) //if(ch%2==0) // use just high gain channels
            {
                ...
                if (delayedTag->at(j)==1) hDelayed->Fill(E);
                ...
                hFullE->Fill(E);
                if(delayedTag->at(j)!=1) hFullE_SansDelayed->Fill(E);
            }
    ...
    char title[200];
    int color[4] = {46,9,1,6}; // {Nat,Enr,All,Aux}
    double natM = 4.0914;
    double enrM = 10.6960;
    double totM = 14.7874;
    ...
    //cLowE_Prompt_Cleaned->cd();
    //cLowE_Prompt_Cleaned->SetLogy();
    //sprintf(title,"E of Prompt Events");
    //hLowE_Prompt_Cleaned->SetTitle(title);
    //hLowE_Prompt_Cleaned->GetYaxis()->SetTitle("Counts");
    //hLowE_Prompt_Cleaned->GetXaxis()->SetTitle("trapECal - 0PtCalShift (keV)");
    hLowE_Prompt_Cleaned->SetLineWidth(2);
    hLowE_Prompt_Cleaned->SetLineColor(color[3]);
    ...
    hLowE_Prompt_Cleaned_Nat->SetLineColor(color[3]);
    ...
    hLowE_Prompt_Cleaned_Enr->SetLineColor(color[3]);
